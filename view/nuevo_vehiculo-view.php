                ...
                <div class="col-md-3">
                    <div class="box box-primary"><!-- Profile Image -->
                     ...
                     <div class="box box-primary"><!-- Profile Image -->
                        <div class="box-body box-profile">
                            <div id="load_img2">
                                <img class=" img-responsive" src="view/resources/images/tenencia.png" alt="Bussines profile picture">
                            </div>
                            <h3 class="profile-username text-center">Tenencia</h3>
                            <p class="text-muted text-center mail-text"></p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" name="update_register" id="update_register" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" required name="patente" class="form-control" id="patente" placeholder="Marca: ">
                                    </div>
                                    <label for="marca" class="col-sm-2 control-label">Placa: </label>
                                    <div class="col-sm-4">
                                        <input type="text" required name="marca" class="form-control" id="marca" placeholder="Placa: ">
                                    </div>
                                </div>
                                <div class="form-group">
