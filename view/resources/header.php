...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="assets/logoitp.ico" type="image/x-icon">
    <!-- Bootstrap core CSS -->
...
<body>
    <section id="container">
        <header id="header">
            <!--logo start-->
            <div class="brand">
                <!--<a href="http://www.itpachuca.edu.mx/" ><span><?php echo $nombre_empresa; ?></span></a>-->
            </div>
            <!--logo end-->
            <div class="toggle-navigation toggle-left">
                <button type="button" class="btn btn-default" id="toggle-left" data-toggle="tooltip" data-placement="right" title="Ocultar/Mostrar menu">
                    <i class="fa fa-bars"></i>
                </button>
                <a>Administración de Recursos Materiales y Servicios
                </a>
                </div>
            <div class="user-nav">
                <ul>
                    <img src=" view/resources/logoTecNM.png" height="55px" width="100px" alt="">
        ...
        <aside class="sidebar">
            <div id="leftside-navigation" class="nano">
                                 <!--<li >
                        <a href="http://www.itpachuca.edu.mx/"><i class="fa fa-cog"></i><span>ITPachuca</span></a>
                    </li>-->
                <ul class="nano-content">
                    ...
                    <li class="<?php if(isset($active9)){echo $active9;}?>">
                        <a href="./?view=tarjetas"><i class="fa fa-credit-card"></i><span>Verificaciones</span></a>
                    </li>
                    <!--
                    <?php } ?>
                    <?php if ($_SESSION['reparaciones']==1) { ?>
                    <li class="<?php if(isset($active10)){echo $active10;}?>">
                        <a href="./?view=reparaciones"><i class="fa fa-gavel"></i><span>Prueba Tío Cesar</span></a>
                    </li>
                  -->
                    <?php } ?>
                    <?php if ($_SESSION['choque']==1) { ?>
                    <li class="<?php if(isset($active11)){echo $active11;}?>">
                        <a href="./?view=choques"><i class="fa fa-code-fork"></i><span>Mantenimiento</span></a>
                    </li>
                    <?php } ?>
