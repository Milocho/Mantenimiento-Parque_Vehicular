        ...
        <section id="main-content">
            <div class="row">
                <div class="col-md-12">
                        ...
                        <!--breadcrumbs end -->
                        <br>
                    <h1 class="h1">Bitácoras Mantenimiento</h1>
                </div>
            </div>
            
            <div class="row">
                <div class="col-xs-3">
                    <span class="text-muted">Busca Por Fecha:</span>
                ...
                <div class="col-md-offset-10">
                    ...
                    <a href="http://localhost/talleres/view/excel.php"
                    class="btn btn-primary"><i class='fa fa-plus'></i> Excel</a>
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Registros de los 
                            Mantenimientos</h3>
