<?php
	...
	$errors[]= "<p>Lo sentimos, pero el archivo es demasiado grande. Selecciona logo de menos de 1MB</p>";
		...
		$img_update="imagen2='view/resources/images/$image_name' ";
    ...
    if ($query_new_insert) {
?>
		<img class="img-responsive" src="view/resources/images/<?php echo $image_name;?>" alt="Imagen del Vehiculo" data-toggle="modal" data-target="#myModal2" style='cursor:pointer'>
