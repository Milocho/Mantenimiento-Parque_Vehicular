<?php
	...
	if ($count==0){
		...
		if ($count2==0){
			...
			$aviso="Aviso!";
			$msj="Error al eliminar los datos. El vehiculo se encuentra vinculado con un mantenimiento";
			$classM="alert alert-danger";
			$times="&times;";
		}	
		...
		$aviso="Aviso!";
		$msj="Error al eliminar los datos. El vehiculo se encuentra vinculado con una verificación";
		$classM="alert alert-danger";
		$times="&times;";
	}	
}
