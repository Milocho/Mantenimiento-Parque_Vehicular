                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" role="form" name="update_register" id="update_register" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <textarea type="text" required name="actividad_economica" class="form-control" id="actividad_economica" placeholder="Actividad Institucional: "><?php echo $actividad_economica ?></textarea> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="dni" class="col-sm-2 control-label">Dep: </label>
                                    <div class="col-sm-4">
