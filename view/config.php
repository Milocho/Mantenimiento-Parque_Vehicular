<?php
		class Conexion{
			...
			function Conexion(){
				...
				$this->baseDatos  ="taller"; //base de datos personas, si quieres utilizar otra base de datos solamente cambiala
			}
			...
			function conectarse(){
				...
				if($enlace){
					echo "Bitacora de Mantenimientos";	//si la conexion fue exitosa nos muestra este mensaje como prueba, despues lo puedes poner comentarios de nuevo: //
				}else{
