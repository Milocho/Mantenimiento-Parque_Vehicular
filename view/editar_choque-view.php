            ...
            <div class="row">
                <div class="col-md-12">
                        ...
                        <ul class="breadcrumb  pull-right">
                            ...
                            <li class=""><a href="./?view=choques">Mantenimiento</a></li>
                            <li class="active">Editar Mantenimiento</li>
                        </ul>
                        <!--breadcrumbs end -->
                        <br>
                    <h1 class="h1">Editar Mantenimiento</h1>
                </div>
            </div>
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" name="update_register" id="update_register" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="fecha_choque" class="col-sm-2 control-label">Fecha del Mantenimiento: </label>
                                    <div class="col-sm-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="dni" class="col-sm-2 control-label">Servicio : </label>
                                    <div class="col-sm-4">
                                        <input type="text" required name="dni" class="form-control" id="dni" placeholder="Servicio : " value="<?php echo $dni_ter ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="patente" class="col-sm-2 control-label">Placa delantera: </label>
                                    <div class="col-sm-4">
                                        <input type="text" required name="patente" class="form-control" id="patente" placeholder="Placa D.: " value="<?php echo $patente_ter ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <label for="celular" class="col-sm-2 control-label">Placa trasera : </label>
                                    <div class="col-sm-4">
                                        <input type="text" required name="celular" class="form-control" id="celular" placeholder="Placa T. : " value="<?php echo $celular_ter ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="telefono" class="col-sm-2 control-label">Kilometraje : </label>
                                    <div class="col-sm-4">
                                        <input type="text" required name="telefono" class="form-control" id="telefono" placeholder="Kilometraje : " value="<?php echo $telefono_ter ?>">
                                    </div>
