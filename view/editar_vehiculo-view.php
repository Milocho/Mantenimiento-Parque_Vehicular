    ...
    <section class="main-content-wrapper">
        <section id="main-content">
            ...
            <div class="row">
                ...
                <div class="box box-primary"><!-- Profile Image2 -->
                        <div class="box-body box-profile">
                            <div id="load_img2">
                                <img class=" img-responsive" src="<?php echo  $imagen2;?>" alt="Foto de la Tenencia" data-toggle="modal" data-target="#myModal2" style='cursor:pointer'>
                            </div>
                            <h3 class="profile-username text-center"><?php echo $vto_vtv;?></h3>
                            <div id="myModal2" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <img src="<?php echo $imagen2;?>" class="img-responsive">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-horizontal" role="form" name="update_register" id="update_register" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="patente" class="col-sm-2 control-label">Marca: </label>
                                    <div class="col-sm-4">
                                        <input type="text" required name="patente" class="form-control" id="patente" placeholder="Marca: " value="<?php echo $patente ?>">
                                    </div>
                                    <label for="marca" class="col-sm-2 control-label">Placa: </label>
                                    <div class="col-sm-4">
                                        <input type="text" required name="marca" class="form-control" id="marca" placeholder="Placa: " value="<?php echo $marca ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                <label for="imagefile2" class="col-sm-2 control-label">Tenencia: </label>
                                    <div class="col-sm-4">
                                        <input type="file" name="imagefile2" class="form-control" id="imagefile2" onchange="upload_image2(<?php echo $vehiculo_id; ?>);">
                                    </div>
...
<script>
    function upload_image(vehiculo_id){
        ...
        function upload_image2(vehiculo_id){
            ...
            $.ajax({
                url: "view/ajax/images/image_vehiculo2_ajax.php",        // Url to which the request is send
                type: "POST",             // Type of request to be send, called as method
                data: data,               // Data sent to server, a set of key/value pairs (i.e. form fields and values)
                contentType: false,       // The content type used when sending data to the server.
                cache: false,             // To unable request pages to be cached
